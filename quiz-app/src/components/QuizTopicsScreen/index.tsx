...
const QuizTopicsScreen: React.FC = () => {
  const { quizTopic, setVoiceMode, selectQuizTopic, setCurrentScreen } = useQuiz()

  const goToQuizDetailsScreen = () => {
    setCurrentScreen(ScreenTypes.QuizDetailsScreen)
  }

  const enableVoiceMode = (mode: boolean) => {
    console.log('enableVoiceMode', mode)
  ...
  return (
    <PageCenter light justifyCenter>
      <CenterCardContainer>
        ...
        <TickButton
          onClick={(event: any, enabled: boolean) => {
            enableVoiceMode(enabled)
          }}
          message="Voice Mode"
        />
